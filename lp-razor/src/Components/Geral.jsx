        ...
        <main>
          <div class="abertura">
            ...
            <div class="bloco-mensagem">
              ...
              <p>
                Uma máquina de alta performance para atender às demandas de hoje
                e do futuro
              </p>
              <a href="#detalhes">
          ...
          <div class="informacoes">
            <section class="diferenciais">
              ...
              <p>
                ...
                precisam de uma máquina potente, capaz de rodar os softwares
                mais complexos e pesados do mercado.
              </p>

              <p>
                Ela é o modelo intermediário da Linha Pro da Razor Computadores,
                capaz de providenciar velocidade e performance na realização de
                tarefas como computação gráfica, renderização, simulações e
                análises robustas.
              </p>

              <p>
                Além disso, seja você um profissional de design, de mídia e
                entretenimento, do setor de contrução, ou do setor de tecnologia
                e desenvolvimento, a Linha Pro de Workstations da Razor é capaz
                de fornecer soluções personalizadas para atender às suas
                necessidades.{" "}
              </p>

              <h3>Processador de Alta Potência</h3>
              <p>
                A Workstation Pro Prodigy possui opções de processadores AMD®
                Ryzen™ de terceira geração e Intel® Core™ de décima geração,
                permitindo a instalação de até 8 núcleos e 16 threads,
                garantindo excelente performance no processamento de dados.
              </p>

              <h3>Placa de Vídeo para Melhor Performance</h3>
              <p>
                Escolha entre as placas de vídeo Nvidia® Geforce™ GTX 1660S, RTX
                3060, RTX 3070 e RTX 3080 e as placas profissionais Nvidia®
                Quadro™ P1000, P2200, RTX 4000 e RTX 5000, capazes de fornecer o
                máximo de performance gráfica.{" "}
              </p>

              <h3>Capacidade de Memória e Armazenamento Expansível</h3>
              <p>
                Na Workstation Pro Prodigy é possível instalar até 28TB de
                armazenamento de dados em disco rígido ou até 6 TB em
                armazenamento All Flash SSD, bem como até 128GB de memória RAM
                DDR4 para garantir o melhor desempenho para o seu sistema.
              </p>

              <h3>Desempenho testado e certificado</h3>
              <p>
                Os modelos da Linha Pro da Razor, entre eles a Workstation
                Prodigy, foram submetidos a mais de 1000 horas de testes, com
                qualidade aprovada para uso em ambientes profissionais altamente
                exigentes.{" "}
              </p>
            ...
            <section class="contate-nos">
              ...
              <div class="contato-box">
                ...
                <p>
                  Ficou interessado em conhecer melhor como a Razor pode ajudar
                  a sua empresa, ou ficou com alguma dúvida? Preencha um breve
                  formulário e um de nossos especialistas irá entrar em contato
                  com você.
                </p>
            ...
            <form>
              ...
              <fieldset>
                ...
                <label for="radio-atualizacao">
                  ...
                  />
                  Atualização: minha máquina atual não tem o desempenho
                  necessário
                </label>
          ...
          <section class="equipe">
            ...
            <p>
              Esta Landing Page foi elaborada pelo Squad 8 do #TeuFuturo Web 2022.
              O #TeuFuturo é uma iniciativa que busca acelerar jovens talentos,
              fornecendo experiências técnicas (em Programação Web) e
              comportamentais para gerar ciclos sustentáveis de inovação e
              transformação social.
            </p>

            <p>
              Nesta edição, patrocinada principalmente pela Razor Computadores,
              foram fornecidas 200 vagas para jovens de 16 a 30 anos, que terão
              até o final do curso mais de 270 horas de atividades online,
              totalmente gratuitas.
            </p>

            <p>
              Confira abaixo os integrantes que participaram ativamente na
              elaboração dessa página:
            </p>
            ...
            <div class="felipe">
              ...
              <p>
                Nascido em Porto Alegre, tem 18 anos e gosta muito de gatos. Gosta
                de praticar atividades diversas e costuma trabalhar em equipe.
                Ingressou no #TeuFuturo em 2022 e atualmente cursa Programação na
                Web. Felipe é o Apresentador oficial, Designer e Desenvolvedor do
                Squad.
              </p>

              <p class="atencao">Contato:</p>
              <ul class="icones">
                <li>
            ...
            <div class="gabriel">
              ...
              <p>
                Natural de Porto Alegre/RS, tem 18 anos e começou a estudar
                programação no início de 2022, graças à oportunidade de participar
                do #TeuFuturo. Apaixonado por gatos, ciências exatas e em aprender
                coisas novas, Gabriel é o Líder, Scrum Master, Líder dos
                Desenvolvedores e Designer do Squad.
              </p>
            ...
            <img class="imagem-squad" src={squad} />
          </section>
        </main>
