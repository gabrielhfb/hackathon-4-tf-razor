...
function Diferenciais() {
  return (
    <section className="diferenciais">
      ...
      <p>
        A Workstation Pro Prodigy foi projetada para profissionais que precisam
        de uma máquina potente, capaz de rodar os softwares mais complexos e
        pesados do mercado.
      </p>
      ...
      <p>
        A Workstation Pro Prodigy possui opções de processadores AMD® Ryzen™ de
        terceira geração e Intel® Core™ de décima geração, permitindo a
      ...
      <p>
        ...
        P2200, RTX 4000 e RTX 5000, capazes de fornecer o máximo de performance
        gráfica.{" "}
      </p>

      <h3>Capacidade de Memória e Armazenamento Expansível</h3>
      <p>
        Na Workstation Pro Prodigy é possível instalar até 28TB de armazenamento
        de dados em disco rígido ou até 6 TB em armazenamento All Flash SSD, bem
        como até 128GB de memória RAM DDR4 para garantir o melhor desempenho
        para o seu sistema.
      </p>
      ...
      <p>
        ...
        foram submetidos a mais de 1000 horas de testes, com qualidade aprovada
        para uso em ambientes profissionais altamente exigentes.{" "}
      </p>
